...
class Project(models.Model):
    ...
    # catalogue_files=models.FileField( blank=True, null=True, upload_to='sai/')
    # labelschema_files=models.FileField( blank=True, null=True, upload_to='reddy/')
...
class Sign(models.Model):
    ...
    order = models.CharField(max_length=2000, blank=True)
    folder_name=models.CharField(max_length=2000, blank=True)
