...
class SignSerializer(serializers.ModelSerializer):
    class Meta:
        model = models.Sign
        fields = ('signid', 'signname','projectid','imagepath','description','group_image','label_mode_dev','label_mode_eva','order','folder_name')
class CatSerializer(serializers.ModelSerializer):

    class Meta:
        model = models.Catlog
        fields = ('signid', 'signname','projectid','imagepath','description','group_image','label_mode_dev','label_mode_eva','order','folder_name')
class CatfolderSerializer(serializers.ModelSerializer):
    class Meta:
        model = models.Catfolder
        fields = ('projectid','folder_name')
